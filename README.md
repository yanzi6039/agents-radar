...
A GitHub Actions workflow that runs every morning at 07:30 CST. It aggregates AI ecosystem signals from 10 data sources, then publishes bilingual (Chinese + English) daily digests as GitHub Issues and committed Markdown files. Weekly and monthly rollup reports are also generated automatically.
...
|----------|------|-----|-----|
| Daily digest | `30 23 * * *` | 23:30 daily | 07:30 daily |
